...
using UnityEngine.UIElements;
    ...
    public class SkillSlot : VisualElement
    {
        public Image Icon;
        ...
        private void OnPointerDown(PointerDownEvent evt)
        {
            ...
            // Start the drag
            // SkillUIController.StartDrag(evt.position, this);
        }
        ...
        #region UXML
        [Preserve]
        public new class UxmlFactory : UxmlFactory<SkillSlot, UxmlTraits> { }
        [Preserve]
